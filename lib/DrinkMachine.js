...
DrinkMachine.prototype = {
    ...
    set_connection_timeout: function(){
        ...
        self.connection_timeout_id = setTimeout(function(){
            self.logger.log_error('Tini error - connection timed out', self.long_name);
            ...
            if(data[data.length - 1] == '\n'){
                ...
                switch(msg[0]){
                    ...
                    case '4': // 4\n - drop ack
                        ...
                        // reset our timeout detector because the drop command resets the tini boards noop interval
